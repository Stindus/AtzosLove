package de.hsba.bi.webshop.atzos.web;


import de.hsba.bi.webshop.atzos.paypal.OrderService;
import de.hsba.bi.webshop.atzos.product.ProductForm;
...
public class ProductController {
    ...
    public String buyProductController(@PathVariable("id") Long id, @RequestParam Long numberBought, Model model) {
        Sale mySale = new Sale(userService.findCurrentUser(), productService.findProductById(id), orderService.findOrderById(id), numberBought);
